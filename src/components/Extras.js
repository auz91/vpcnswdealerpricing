const extras = {
    ...
    pitchone: [{ id: 5, cost: 50, name: "Roof Pitch Between 35-40 Degrees", description: "Roof pitch is over 35 degrees but less than 40", unit: "Panel" }],
    pitchtwo: [{ id: 6, cost: 100, name: "Roof Pitch Between 40-45 Degrees", description: "Roof pitch is over 40 degrees but less than 45. Over 45 does not qualify.", unit: "Panel" }],
